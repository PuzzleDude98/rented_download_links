...
::Also you can change the color by changing the suber where it says COLOR 07 up top. The first digit is the background color and the second is the text color.
